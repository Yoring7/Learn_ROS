...
class addintRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type addintRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type addintRequest
    let len;
    let data = new addintRequest(null);
  ...
  static datatype() {
    ...
    return 'plumbing_server_client/addintRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addintRequest(null);
...
class addintResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type addintResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type addintResponse
    let len;
    let data = new addintResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_server_client/addintResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new addintResponse(null);
