...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcp_pub_sub-msg:<person> is deprecated: use tcp_pub_sub-msg:person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_pub_sub-msg:name-val is deprecated.  Use tcp_pub_sub-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_pub_sub-msg:age-val is deprecated.  Use tcp_pub_sub-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_pub_sub-msg:height-val is deprecated.  Use tcp_pub_sub-msg:height instead.")
  (height m))
